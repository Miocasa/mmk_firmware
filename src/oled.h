...
#define FPS_TO_MS(n) (1000 / n)
    ...
    struct AnimationParams {
        ...
        uint8_t frame_count;
        uint8_t key_icons[3][3];
        uint8_t enc_key_icons[3];
    };
    ...
    constexpr AnimationParams LAYER_ANIM[LAYER_COUNT] = {
        ...
        [KRITA_ALT] = {
            ...
            krita_alt_layer_anim_frames,
            {
                ...
                {ICON_DUPLICATE, ICON_TRNS, ICON_TRNS},
                {ICON_LAYER_UP, ICON_LAYER_DOWN, ICON_UNDO},
                {ICON_TAP_DANCE, ICON_TRNS, ICON_TRNS}
            },
            {ICON_TRNS, ICON_TRNS, ICON_TRNS},
        },
...
#define KEYS_ART_POS_Y 60
    ...
    drawIcon(
        ...
        KEYS_ART_POS_X,
        KEYS_ART_POS_Y,
        LAYER_ANIM[layer].enc_key_icons[0],
        SSD1306_WHITE
    );
    ...
    drawIcon(
        ...
        KEYS_ART_POS_X + 16,
        KEYS_ART_POS_Y,
        LAYER_ANIM[layer].enc_key_icons[1],
        SSD1306_WHITE
    );
    ...
    drawIcon(
        ...
        KEYS_ART_POS_X + 32,
        KEYS_ART_POS_Y,
        LAYER_ANIM[layer].enc_key_icons[2],
        SSD1306_WHITE
    );
    ...
    for (uint8_t i = 0; i < 3; i++) {
        for (uint8_t j = 0; j < 3; j++) {
            drawIcon(
                ...
                LAYER_ANIM[layer].key_icons[j][i],
                SSD1306_WHITE
            );
            display->drawRoundRect(
                KEYS_ART_POS_X + 16 * i,
